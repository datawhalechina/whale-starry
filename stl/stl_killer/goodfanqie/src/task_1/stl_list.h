...
namespace std _GLIBCXX_VISIBILITY(default) {
  ...
  class _List_base {
   protected:
    ...
    struct _List_impl : public _Node_alloc_type {
      ...
      _List_impl()
          _GLIBCXX_NOEXCEPT_IF(is_nothrow_default_constructible<_Node_alloc_type>::value)
          : _Node_alloc_type() {}
   ...
   public:
    ...
    _Node_alloc_type& _M_get_Node_allocator() _GLIBCXX_NOEXCEPT { return _M_impl; }
  ...
  class list : protected _List_base<_Tp, _Alloc> {
   ...
   public:
    list(list&& __x,
         const allocator_type& __a) noexcept(_Node_alloc_traits::_S_always_equal())
